...
package com.raaju.materialdaterangepicker.date;
...
import com.raaju.materialdaterangepicker.HapticFeedbackController;
import com.raaju.materialdaterangepicker.R;
import com.raaju.materialdaterangepicker.TypefaceHelper;
import com.raaju.materialdaterangepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
  ...
  public interface OnDateSetListener {
     ...
     */
    void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth, int yearEnd,
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    startDatePage.setIndicator((startTitle != null && !startTitle.isEmpty()) ? startTitle
        : activity.getResources().getString(R.string.mdtp_from));
    ...
    endDatePage.setIndicator((endTitle != null && !endTitle.isEmpty()) ? endTitle
        : activity.getResources().getString(R.string.mdtp_to));
    ...
    mDayPickerView =
        new SimpleDayPickerView(activity, this);
    mYearPickerView = new YearPickerView(activity, this);
    mDayPickerViewEnd =
        new SimpleDayPickerView(activity, this);
    mYearPickerViewEnd =
        new YearPickerView(activity, this);
    ...
    mAnimator = (AccessibleDateAnimator) view.findViewById(
        R.id.animator);
    mAnimatorEnd =
        (AccessibleDateAnimator) view.findViewById(
            R.id.animator_end);
    ...
    tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
      ...
      public void onTabChanged(String tabId) {
        ...
        if (tabId.equals("start")) {
          calendarDay = new MonthAdapter.CalendarDay(
  ...
  /**
   * If set to true, all days between {@link #highlightedDays} and {@link #highlightedDaysEnd} will
   * be highlighted.
   * This will reset manually inserted days to highlight using {@link
   * #setHighlightedDays(Calendar[], Calendar[])}
   *
  ...
  public void onClick(View v) {
    ...
    if (v.getId() == R.id.date_picker_year || v.getId() == R.id.date_picker_year_end) {
      setCurrentView(YEAR_VIEW);
        ...
        || v.getId() == R.id.date_picker_month_and_day_end) {
